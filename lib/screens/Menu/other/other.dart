...
import 'package:golfandtango/screens/Menu/other/bartools.dart';
import 'package:golfandtango/screens/Menu/other/clothes.dart';
...
class _OtherMenuState extends State<OtherMenu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Center(child: Text('Menu: Other ')),
                  ...
                  children: catagories.map((catagory) {
                    return GestureDetector(
                      ...
                      onTap: () {
                        ...
                        else if (catagory == "Bar Tools")
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => BarToolsList()));
                        else
                          Navigator.push(
                              context,
                              MaterialPageRoute(
